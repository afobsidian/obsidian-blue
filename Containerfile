...
--mount=type=cache,sharing=locked,dst=/var/cache/pacman,id=pacman-cache-obsidian-blue-latest-stage-obsidian-blue \
--mount=type=cache,sharing=locked,dst=/usr/lib/sysimage/cache/pacman,id=pacman-sysimage-cache-obsidian-blue-latest-stage-obsidian-blue \
/tmp/scripts/run_module.sh 'dnf' '{"type":"dnf","repos":{"cleanup":true,"files":["lionheartp-hyprland.repo","jdxcode-mise.repo","tailscale.repo"]},"install":{"skip-unavailable":true,"skip-broken":true,"install-weak-deps":false,"packages":["hyprland-git","hyprland","xdg-desktop-portal-hyprland","hyprpaper","hyprlock","hypridle","hyprland-qtutils","hyprland-plugins","hyprpicker","hyprshot","hyprpolkitagent","hyprsunset","hyprland-contrib","satty","alacritty","bat","bind-utils","btop","bluez","cascadia-code-nf-fonts","cascadia-mono-nf-fonts","chromium","clang","dbus-tools","du-dust","evince","fastfetch","fcitx5","fcitx5-configtool","fcitx5-gtk","fcitx5-qt","fontawesome-fonts-all","gnome-calculator","gnome-keyring","gnome-themes-extra","google-noto-fonts-common","gum","gvfs-mtp","gvfs-smb","iwd","libxkbcommon-utils","mise","nautilus","pipewire-devel","pipx","plocate","plymouth","power-profiles-daemon","sushi","swaybg","tldr","usbutils","uwsm","wf-recorder","whois","wiremix","xdg-desktop-portal-gtk","xdg-terminal-exec","xdg-user-dirs","xmlstarlet","yaru-icon-theme","zoxide","swappy","cliphist","SwayNotificationCenter","mpv","nwg-look","qt5ct","qt6ct","kvantum","wlogout","ImageMagick","tumbler","yad","yt-dlp","imv","NetworkManager-tui","python3-gobject","python3-i3ipc","python3-pyudev","gtk-layer-shell","python3-build","python3-installer","python3-setuptools","python3-wheel","cargo","rust","gcc","dbus-devel","code","kubectl","helm","gh","neovim","ripgrep","fd-find","jq","yq","zsh","tailscale","perf","sysprof","sddm","qt6-qtquickcontrols2","qt6-qtsvg"]},"remove":{"packages":["tuned-ppd","wlsunset","dunst","mako","ibus","greetd","gtkgreet"]}}'
RUN \
--mount=type=bind,from=stage-files,src=/files,dst=/tmp/files,rw \
