...
/tmp/scripts/run_module.sh 'script' '{"type":"script","scripts":["clear-rpmfusion-dnf-cache.sh"]}'
RUN \
--mount=type=bind,from=stage-files,src=/files,dst=/tmp/files,rw \
